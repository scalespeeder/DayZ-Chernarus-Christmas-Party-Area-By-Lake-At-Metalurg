DayZ "Chernarus Christmas Party Area At The Lake By Metalurg" For Console and PC json Custom Spawner Mod Instructions & Terms Of Use

This custom object spawner json file will spawn in a "Christmas Party" area by the lake at Metalurg, Plotina Tishina, 1232.43 / 6532.46
...
(Optional: For advanced users I have included the original DayZ Editor Mod file "xmasarea.dze" which can be imported into DayZ Editor Mod on PC for customisation.)
...
Upload "chernmetalurgxmasarea.json" from the extracted files to inside the "custom" folder of the mission directory on your server. This file places the area on your map.
...
Edit it to look like this: 
	...
	"objectSpawnersArr": ["custom/chernmetalurgxmasarea.json"],
	
If you already are calling custom jsons to spawn items, seperate the files like this:

	"objectSpawnersArr": ["custom/chernmetalurgxmasarea.json","custom/anotherfile.json","custom/differentfile.json"],
	
Save your changes & upload if you need to.

Restart your server and the "Christmas Party Area" will appear immediatly, and then it will be replensished on Server Restarts.
